<nav class="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
    <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
            ...
            <!-- Logo/Brand -->
            <a href="/todo" class="flex items-center justify-between mr-4">
                ...
                <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="user-dropdown">
                    <li>
                        <button wire:click="logout"
                            class="flex items-center w-full py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-left">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
